  ...
  try {
    ...
    const chat = model.startChat({
      history: [
        {
          role: "user",
          parts: [{ text: `${SYSTEM_PROMPT}\n\n${contextData ? `Here is the current specialized data you can use to answer questions:\n${contextData}` : ''}` }],
        },
        {
          role: "model",
          parts: [{ text: "Understood. I am ready to assist as the ClinicConnect AI assistant." }],
        },
      ],
      generationConfig: {
        maxOutputTokens: 500,
